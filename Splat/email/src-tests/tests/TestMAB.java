...
public class TestMAB extends EmailTest{
  ...
  public void test01() {
    ...
    Assert.assertTrue(Client.sendEmail(urubu, "picapau", "abc", "you need 25c for a soda") instanceof Email);
...
//    Assume.assumeTrue(EmailVariables.getSINGLETON().isADDRESSBOOK___());
    ...
    Assert.assertFalse(urubu.getAddressBookReceiversForAlias("sucker").isEmpty());
  }
