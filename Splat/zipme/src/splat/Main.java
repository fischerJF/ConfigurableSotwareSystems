...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // String dataPath = (new
    // java.io.File("./../..")).getCanonicalPath().toString() + "/data/valid/";
    ...
    while (index < totalExecution) {
      ...
      args = new String[] { "--testclass", "tests.TestAll", "--logfile",
          dataPath + "zipme_splat.txt", "--shouldsample", "false",
          "--samplerate", "1", "--seed", "95729", "--validate", "true" };
    ...
    // List<TestResults> resultsMostEnabledDisabled =
    // ExperimentRunner.runExp(args,
    // ZipMeVariables.getSINGLETON());
    //
    //// args = new String[] { "--testclass", "tests.TestAll", "--logfile",
