...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		while (index < totalExecution) {
			...
			args = new String[] { "--testclass", "tests.TestAll", "--logfile", dataPath + "gpl_splat.txt",
					"--shouldsample", "false", "--samplerate", "1", "--seed", "95729", "--validate", "true" };// TEM
																												// COLOCAR
																												// FALSE
			List<TestResults> resultsSplat = ExperimentRunner.runExp(args, GPLVariables.getSINGLETON());
