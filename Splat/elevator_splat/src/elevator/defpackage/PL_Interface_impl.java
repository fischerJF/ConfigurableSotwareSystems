...
import elevator.TestSpecifications.SpecificationManager;
...
public  class  PL_Interface_impl  implements PL_Interface {
	...
	//@Symbolic("false")
	private static int cleanupTimeShifts = 20000; //24;

	
	private static final int NUM_FLOORS = 100000;
	...
	public void test(int specification, int variation) {
		if (variation==-1) {
			...
			case 10: chpkimSpecification10(); break; /*isAbortedRun=true;break; */
 ...
 */
	...
	public void Specification1() {
		...
		System.out.println("cleanupTimeShifts: " + cleanupTimeShifts);
		for (int i = 0; i < cleanupTimeShifts && e.isBlocked(); i++)
		{
			e.timeShift();
			System.out.println("i is " + i + " and cleanupTimeshifts is " + cleanupTimeShifts);	
		}
	}
	...
	//<chpkim
	public void chpkimSpecification10() {
	...
	public void Specification14() {
		Environment env = new Environment(ElevatorVariables.FLOORS/2);
		Elevator e = new Elevator(env, false);
		Actions a = new Actions(env, e);
