...
//  }
  ...
  /* caso interessante para a feature  GUIs*/
  @Test
  public void testUndoBean() {
    //S-SPLat não estava com a feature GUI ativa 
   // if(Configuration.GUI && Configuration.TOTAL_REDUCER && Configuration.CUT_NO_DEPARTMENT) {
